# Generated by Django 5.1.2 on 2024-12-03 01:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('allergies', models.JSONField(blank=True, choices=[('none', 'None'), ('dogs', 'Dogs'), ('cats', 'Cats'), ('dust', 'Dust'), ('pollen', 'Pollen'), ('mold', 'Mold'), ('fragrance', 'Fragrance'), ('SLS', 'SLS'), ('ammonia', 'Ammonia'), ('bleach', 'Bleach'), ('other', 'Other')], default='none', null=True)),
        ...
        migrations.AddField(
            model_name='job',
            name='services',
            field=models.ManyToManyField(related_name='jobs', to='main.service'),
        ),
        migrations.CreateModel(
